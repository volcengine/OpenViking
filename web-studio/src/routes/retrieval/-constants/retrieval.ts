...
export const LAST_RETRIEVAL_SEARCH_KEY = 'openviking.web-studio.retrieval.lastSearch'

export const KNOWN_VIKING_SCOPES = new Set(['agent', 'resources', 'session', 'temp', 'user'])
export const LOADING_HINT_KEYS = ['loading.vector', 'loading.scan', 'loading.match', 'loading.rerank'] as const
