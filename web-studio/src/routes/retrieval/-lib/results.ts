import { fileNameFromUri, normalizeDirUri, normalizeFileUri, parentUri as getParentUri } from '#/lib/viking-uri'
...
export function resourceSearchForResult(item: FindResultItem): { uri: string; file?: string } {
