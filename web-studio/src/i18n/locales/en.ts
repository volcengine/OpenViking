  ...
  monitoringPage: {
    ...
    metricsTiles: {
      ...
      httpSuccessRate: {
        ...
        tooltip: 'Percentage of 2xx HTTP requests across all API calls',
      },
      vectorCount: {
        title: 'VikingDB Vectors',
        subText: 'Mounted context collection',
        tooltip: 'Total active vector count mounted in VikingDB context collection',
      },
      vectorHitRate: {
        title: 'Vector Recall Hit Rate',
        subText: 'Effective retrieval rate',
        tooltip: 'Percentage of non-empty retrieval queries (100% - Zero-Result Rate)',
      },
      gpuVramUsage: {
        title: 'RTX VRAM & GPU Usage',
        subText: 'RTX 2080 Ti (74.2% usage)',
        tooltip: 'Physical node RTX 2080 Ti 22.5GB VRAM and GPU utilization rate',
      },
      top1Accuracy: {
        title: 'Top-1 Precision Accuracy',
        subText: 'Top-1 semantic precision',
        tooltip: 'Precision accuracy ratio for Top-1 semantic hit prediction',
      },
      avgCosineScore: {
        title: 'Avg Cosine Score',
        subText: 'Range: 0.0007 - 0.9972',
        tooltip: 'Average Cosine Score for recalled vector matches (0 to 1 range)',
      },
      embeddingLatency: {
        title: 'Embedding Latency',
        subText: 'Avg vectorization time',
        tooltip: 'Average response latency for single Embedding vectorization & indexing (ms)',
      },
      maxLatency: {
        title: 'Max Peak Latency',
        subText: 'Single request peak',
        tooltip: 'Maximum peak latency recorded for a single API request in cycle (P99 Peak)',
      },
      totalAuditLogs: {
        title: 'Total Audit Logs',
        subText: 'Console Audit records',
        tooltip: 'Total persisted records in Console Audit log',
      },
      autoRefreshStatus: {
        title: 'Auto Refresh Status',
        subText: '60s viewport lazy pull',
        tooltip: 'Frontend 60s lazy focus-aware refresh status (suspended when off-screen)',
      },
      queueState: {
        title: 'Task Queue State',
        subText: 'In-progress / Pending',
        tooltip: 'In-progress and pending queue task count for session commits and semantic nodes',
      },
      peerCount: {
        title: 'Agent Peers Count',
        subText: 'All caregiver peers active',
        tooltip: 'Active caregiver Agent Peer count over total cluster nodes',
      },
      tokenTotal: {
        title: 'Total Tokens Consumed',
        subText: 'Today Embedding Tokens',
        tooltip: 'Total today & cumulative Tokens consumed for Embedding and VLM',
      },
      memorySlimmingRate: {
        title: 'Memory Compression Rate',
        subText: 'Raw files ➔ Memory Tokens',
        tooltip: 'Token compression ratio when distilling raw content into memory entries',
      },
      vectorizationRate: {
        title: 'EMB Vectorization Rate',
        subText: 'OpenViking EMB throughput',
        tooltip: 'OpenViking engine vector generation and index throughput rate (Vec/s)',
      },
      activeModels: {
        title: 'Active AI Models',
        subText: 'Configured model engines',
        tooltip: 'Currently configured Embedding, VLM, and Rerank model engines',
      },
    },
    hardwareCharts: {
    ...
    analyticsCharts: {
      ...
      tokenPieSubtitle: 'Physical Token usage breakdown across VLM and Embedding models',
      tokenPieTooltip: 'Visualizes Token usage proportions across models to identify cost distribution.',
