const workspace = {
  ...
  tasksPage: {
    ...
    events: {
      ...
      operationStarted: '操作开始',
      operationCompleted: '操作流程完成',
      operationFailed: '操作失败',
      operationCancelled: '操作已取消',
      operationSkipped: '操作已跳过',
      archiveSummary: '归档摘要处理',
      longTermMemoryExtraction: '长期记忆提取',
      discarded: '已有 {{count}} 条任务事件被丢弃。',
      refreshFailed: '事件刷新失败，当前展示上次获取的记录。',
      skipReasons: {
        working_memory_disabled: '工作记忆已关闭。',
        extractor_unavailable: '记忆提取组件不可用。',
        extraction_disabled: '记忆提取已关闭。',
        no_eligible_scope: '没有符合策略的记忆提取范围。',
        no_memory_types: '没有符合策略的记忆类型。',
        no_pending_messages: '本次没有待提取的消息。',
      },
