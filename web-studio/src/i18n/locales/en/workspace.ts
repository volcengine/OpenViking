const workspace = {
  ...
  tasksPage: {
    ...
    events: {
      ...
      archiveSummary: 'Archive summary processing',
      longTermMemoryExtraction: 'Long-term memory extraction',
      discarded: '{{count}} task events were dropped.',
      refreshFailed:
        'Events could not be refreshed; showing the last available response.',
      skipReasons: {
        working_memory_disabled: 'Working memory is disabled.',
        extractor_unavailable: 'The memory extractor is unavailable.',
        extraction_disabled: 'Memory extraction is disabled.',
        no_eligible_scope: 'No eligible memory scope.',
        no_memory_types: 'No eligible memory types.',
        no_pending_messages: 'No messages remain to be extracted in this run.',
      },
