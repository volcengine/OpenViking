...
export type MemoryOpenVikingConfig = {
  ...
  recallTargetTypes?: Array<"resource" | "session" | "user" | "agent">;
...
export const OPENVIKING_ALL_TOOL_NAMES = [OPENVIKING_ADD_RESOURCE_TOOL_NAME, ...OPENVIKING_DEFAULT_ENABLED_TOOL_NAMES] as const;
