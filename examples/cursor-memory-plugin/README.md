...
The hooks inject baseline context on session start and prompt-specific memory before each request, capture transcript deltas on stop, and commit before compaction or session end.
