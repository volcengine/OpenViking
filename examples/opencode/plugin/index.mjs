...
/**
 * OpenViking plugin for OpenCode with native tool integration.
 *
 * Exposes memory, search, and code tools directly through OpenCode's tool hooks.
 * No skill loading required - tools are always available in the agent's inventory.
 *
