<table width="100%">
  <tr>
    ...
    <td align="center" valign="middle" width="70%">
      <h3>OpenViking: AIエージェントのためのコンテキストデータベース</h3>
      <p>
      ...
      <p>
        <a href="https://docs.openviking.ai/en/about/01-about-us#lark-group" title="Larkグループ"><img src="docs/images/community/lark.svg" width="24" height="24" alt="Larkグループ"></a>&nbsp;&nbsp;&nbsp;&nbsp;
