...
class CategoryReranker:
    ...
    def from_payload(cls, payload: dict[str, Any] | None, *, repo_root: Path) -> "CategoryReranker":
        ...
        return cls(
            ...
            positive_match_required=_as_bool(payload.get("positive_match_required"), default=True),
            no_match_policy=str(payload.get("no_match_policy") or "skip_injection"),
            search_score_weight=float(payload.get("search_score_weight") or 1.0),
        )
...
def _candidate_score(
    ...
    *,
    ...
    reasons = ["openviking_score", "raw_rank_tiebreak"]
    ...
    *,
    ...
    for index, row in enumerate(rows, start=1):
        ...
        if candidate:
            ...
            traced["memory_category"] = candidate.get("memory_category")
