...
"""Fixtures for service tests that exercise transaction-backed reindexing."""
...
class MemoryAgfs:
    """Small synchronous AGFS double matching the transaction test contract."""
...
def test_dir(agfs_client):
    path = f"/local/default/service-{uuid.uuid4().hex}"
