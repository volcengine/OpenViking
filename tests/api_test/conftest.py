...
TEST_CASE_DESCRIPTIONS = {
    ...
    "test_build_document_resources_slow.py::TestBuildDocumentResourcesSlow::test_build_doc_file": "TC-B06 .doc构建",
...
TEST_CASE_APIS = {
    ...
    "test_build_document_resources_slow.py::TestBuildDocumentResourcesSlow::test_build_doc_file": "/api/v1/resources",
