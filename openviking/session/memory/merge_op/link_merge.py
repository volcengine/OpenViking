...
from openviking.core.namespace import context_type_for_uri, uri_parts
...
def is_allowed_wiki_link(
    ...
    *,
    ...
    """Keep graph WikiLinks between memory pages, preserving legacy resource refs."""
    ...
    from_resource = from_context == "resource"
    to_resource = to_context == "resource"
