...
from openviking.parse.parsers.code.ast.extractor import supports_code_skeleton
...
class MarkdownParser(BaseParser):
    ...
    async def _compute_layout(
        ...
        **kwargs,
        ...
        # This yields foo.py/foo.md, allowing skeleton language detection to recover
