...
def normalize_peer_id(peer_id: Optional[str], agent_id: Optional[str] = None) -> Optional[str]:
    """Normalize legacy agent_id request fields into peer_id."""
    if peer_id == "":
        peer_id = None
    if agent_id == "":
        agent_id = None
    ...
    normalized = peer_id or agent_id
