...
✨ **2026年5月更新**：更新 OpenViking 在 User Memory、Agent Memory 和知识库问答三场景上的评测结果。 &rarr; 见 [评测结果](#-评测结果)。
...
<table style="width: 100%; table-layout: fixed;">
  <thead>
    <tr>
      <th style="text-align: center; width: 8%;">实验编号</th>
      <th style="text-align: left; width: 28%;">方案</th>
      <th style="text-align: right; width: 18%; white-space: nowrap;">Query 平均耗时</th>
      <th style="text-align: right; width: 16%;">问答准确率</th>
      <th style="text-align: right; width: 30%;">Agent 总输入 Token</th>
    </tr>
  </thead>
  <tbody>
    <tr>
