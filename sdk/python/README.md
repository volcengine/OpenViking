...
This repository also contains manual smoke scripts under `sdk/python/manual_smoke/`. They are for local verification against a running OpenViking service and are intentionally kept separate from the published SDK package.
