...
Recovered from prior 7/8 to 8/8. Generic terminal communication handling now preserves required communication literal `1628` before done when DB/actions are already aligned.
