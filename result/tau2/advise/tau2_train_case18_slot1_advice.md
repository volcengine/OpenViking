...
Regressed from S008 7/8 to 5/8. Remaining failures are return-leg/flight+baggage write binding and occasional transfer/done before complete write. Next work should narrow case10 guard side effects and preserve selected outbound/return/payment rows.
