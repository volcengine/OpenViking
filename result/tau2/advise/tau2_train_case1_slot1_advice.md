...
Stable at 8/8 under S008+case10 guard. Preserve matched reservation read -> required DB/communication sequence; avoid broad prompt changes that perturb this already-solved case.
