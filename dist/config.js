...
function resolveAgentPrefix(configured) {
...
export const memoryOpenVikingConfigSchema = {
    parse(value) {
        ...
        const hasExplicitAgentScopeMode = typeof cfg.agentScopeMode === "string" || getEnv("OPENVIKING_AGENT_SCOPE_MODE") !== undefined;
        const rawAgentScope = cfg.agentScopeMode ?? getEnv("OPENVIKING_AGENT_SCOPE_MODE");
        const agentScopeMode = rawAgentScope === "user_agent" ? "user_agent" : "agent";
        const explicitIsolateUserScopeByAgent = typeof cfg.isolateUserScopeByAgent === "boolean"
            ? cfg.isolateUserScopeByAgent
            : undefined;
        const explicitIsolateAgentScopeByUser = typeof cfg.isolateAgentScopeByUser === "boolean"
            ? cfg.isolateAgentScopeByUser
            : undefined;
        const envIsolateUserScopeByAgent = explicitIsolateUserScopeByAgent === undefined &&
            getEnv("OPENVIKING_ISOLATE_USER_SCOPE_BY_AGENT") !== undefined
            ? envFlag("OPENVIKING_ISOLATE_USER_SCOPE_BY_AGENT")
            : undefined;
        const envIsolateAgentScopeByUser = explicitIsolateAgentScopeByUser === undefined &&
            getEnv("OPENVIKING_ISOLATE_AGENT_SCOPE_BY_USER") !== undefined
            ? envFlag("OPENVIKING_ISOLATE_AGENT_SCOPE_BY_USER")
            : undefined;
        const isolateUserScopeByAgent = explicitIsolateUserScopeByAgent ??
            envIsolateUserScopeByAgent ??
            false;
        const isolateAgentScopeByUser = explicitIsolateAgentScopeByUser ??
