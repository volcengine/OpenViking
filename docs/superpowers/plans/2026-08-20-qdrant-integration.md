...
- [ ] **Step 1: Add the minimal HTTP client**
...
- [ ] **Step 2: Implement collection existence and metadata**
...
- [ ] **Step 4: Run transport/lifecycle tests**
...
- [ ] **Step 3: Implement adapter factory/config wiring**
...
- [ ] **Step 1: Add failing sparse tests**
...
- [ ] **Step 1: Write environment-gated tests**
...
- [ ] **Step 2: Run the integration tests when available**

Run: `QDRANT_URL=http://127.0.0.1:6333 uv run --project . pytest -q tests/integration/test_qdrant_integration.py`
...
- [ ] **Step 1: Add configuration and capability docs**
