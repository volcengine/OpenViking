...
| `temp_upload.shared_ttl_seconds` | int | Retention time for shared temporary upload directories, in seconds. Each shared upload removes directories older than this from the current account; must be greater than `0`. | `86400` (24 hours) |
