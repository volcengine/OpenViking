...
| tags | List[str] | No | None | Explicit retrieval tag strings. Multiple normalized tags are combined with AND; a result must contain every requested tag |
