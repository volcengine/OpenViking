...
| **Compressor** | Memory compression | Configured memory-category extraction, LLM deduplication decisions |
...
4. **Memory Extraction**: Extract configured memory categories from messages
