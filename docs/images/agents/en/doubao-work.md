...
1. Open Doubao Work, select **Skills · Connectors · Partners** in the sidebar, search for “OpenViking Context,” and select **+**.
...
3. Select **Save and Connect**. Integration is complete when the “Connector installed” message appears and the **+** next to “OpenViking Context” changes to the added state.
