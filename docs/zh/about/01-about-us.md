...
- **代码**：在 [Issues](https://github.com/volcengine/OpenViking/issues) 报告 Bug、提出功能建议，通过 [Pull Request](https://github.com/volcengine/OpenViking/pulls) 贡献代码，参与代码审查。
- **文档**：完善指南和 API 文档，补充示例，或协助翻译。
- **社区支持**：解答问题，分享使用经验和实践。
- **生态**：开发插件，推动与其他框架的集成，在 [Discussions](https://github.com/volcengine/OpenViking/discussions) 分享应用案例。
