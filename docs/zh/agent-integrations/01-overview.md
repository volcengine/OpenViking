...
| **LangChain / LangGraph** | [LangChain and LangGraph](../../en/agent-integrations/05-langchain-langgraph.md) — retriever、`viking_*` tools、LangGraph store 和 workflow middleware |
