...
const posts = computed(() =>
  site.postList.filter(post => post.path && !post.path.endsWith('/')),
)
...
<template>
  <main class="blog-index">
    <section class="blog-hero">
      ...
      <h1>Notes from the context layer</h1>
      <p class="blog-intro">
        Product notes, architecture essays, and release stories for people building context-aware agents.
      </p>
    </section>
