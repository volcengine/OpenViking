...
## Separate writing from reference
...
- Architecture tradeoffs behind context storage and retrieval.
- Release notes that need narrative, not just a changelog entry.
- Product thinking about how agents should use memory, resources, and skills.
