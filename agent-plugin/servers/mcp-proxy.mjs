 ...
 * verbatim copies of examples/memory-plugin-shared/lib (same content and
 * GENERATED header that `node examples/memory-plugin-shared/sync.mjs` emits),
 * so this directory can be added to that script's TARGETS to automate the sync.
 *
