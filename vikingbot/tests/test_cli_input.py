...
def mock_prompt_session():
    ...
    with patch("vikingbot.cli.commands._PROMPT_SESSION", mock_session):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("vikingbot.cli.commands.PromptSession") as MockSession, \
         patch("vikingbot.cli.commands.FileHistory") as MockHistory, \
